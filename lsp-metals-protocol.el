...
(lsp-interface
  ...
  (TreeViewChildrenParams (:viewId) (:nodeUri))
  (TreeViewChildrenResult (:nodes) nil)
  (TreeViewParentParams (:viewId :nodeUri) nil)
  (TreeViewParentResult nil (:uri))
  (TreeViewDidChangeParams (:nodes) nil)
  (TreeViewVisibilityDidChangeParams (:viewId :visible) nil)
  (TreeViewNodeCollapseDidChangeParams (:viewId :nodeUri :collapsed) nil)
  (MetalsTreeRevealResult (:viewId :uriChain) nil))
